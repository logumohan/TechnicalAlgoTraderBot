...
CREATE MATERIALIZED VIEW IF NOT EXISTS INSTRUMENT_ONEMIN WITH (TIMESCALEDB.CONTINUOUS, timescaledb.materialized_only = false) AS 
...
CREATE MATERIALIZED VIEW IF NOT EXISTS INSTRUMENT_THREEMIN WITH (TIMESCALEDB.CONTINUOUS, timescaledb.materialized_only = false) AS 
...
/*
CREATE MATERIALIZED VIEW IF NOT EXISTS INSTRUMENT_FIVEMIN WITH (TIMESCALEDB.CONTINUOUS, timescaledb.materialized_only = false) AS 
...
CREATE MATERIALIZED VIEW IF NOT EXISTS INSTRUMENT_FIFTEENMIN WITH (TIMESCALEDB.CONTINUOUS, timescaledb.materialized_only = false) AS 
...
CREATE MATERIALIZED VIEW IF NOT EXISTS INSTRUMENT_ONEHOUR WITH (TIMESCALEDB.CONTINUOUS, timescaledb.materialized_only = false) AS 
...
CREATE MATERIALIZED VIEW IF NOT EXISTS INSTRUMENT_DAILY WITH (TIMESCALEDB.CONTINUOUS, timescaledb.materialized_only = false) AS 
