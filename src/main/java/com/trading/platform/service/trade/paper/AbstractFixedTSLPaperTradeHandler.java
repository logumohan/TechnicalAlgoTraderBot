...
public abstract class AbstractFixedTSLPaperTradeHandler extends AbstractFixedTSLTradeHandler {

	private AtomicInteger orderIdGenerator;

	protected AbstractFixedTSLPaperTradeHandler(Job job, TradeInfo tradeInfo, TradeManager tradeManager,
