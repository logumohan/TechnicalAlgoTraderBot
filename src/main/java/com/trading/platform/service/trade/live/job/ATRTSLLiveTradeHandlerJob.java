...
import com.trading.platform.service.trade.live.AbstractATRTSLLiveTradeHandler;
import com.trading.platform.util.MarketTimeUtil;
import com.zerodhatech.kiteconnect.utils.Constants;
import com.zerodhatech.models.Order;

public class ATRTSLLiveTradeHandlerJob extends AbstractATRTSLLiveTradeHandler {

	public ATRTSLLiveTradeHandlerJob(Job job, TradeInfo tradeInfo, TradeManager tradeManager,
		...
		LOGGER.trace("ATR TSL live trade handler is intialized");
	}
		...
		try {
			...
			if (sellOrder != null) {
				...
				for (PositionInfo positionInfo : getTradeInfo().getPositionInfoList()) {
					...
					getTradeManager().publishPositionInfo("Trailing Stop Loss Hit", positionInfo);
				}
			} else {
